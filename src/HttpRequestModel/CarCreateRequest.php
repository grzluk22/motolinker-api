...
#[OA\Schema(
    ...
    description: "Request body do tworzenia samochodu",
    type: "object",
    required: ["manufacturer", "model", "type", "model_from", "model_to", "body_type", "drive_type", "displacement_liters", "displacement_cmm", "fuel_type", "kw", "hp", "cylinders", "valves", "engine_type", "engine_codes", "kba"],
    properties: [
