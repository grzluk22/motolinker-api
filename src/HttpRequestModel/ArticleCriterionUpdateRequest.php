...
#[OA\Schema(
    schema: "ArticleCriterionUpdateRequest",
    description: "Request body do aktualizacji kryterium artykułu",
    type: "object",
    required: ["id", "id_article", "id_criterion", "value", "value_description"],
    properties: [
...
class ArticleCriterionUpdateRequest
{
    public int $id;
