...
class ArticleController extends AbstractController
{
    ...
    /**
     * Wszystkie article_codes w formie tabeli
     */
    #[OA\Tag(name: "Article")]
    #[OA\Response(
        response: 200,
        description: "Lista wszystkich kodów artykułów",
        content: new OA\JsonContent(
            type: "array",
            items: new OA\Items(type: "string")
        )
    )]
    #[Route('/article/codes', name: 'app_article_get_codes', methods: ["GET"])]
    public function getCodes(ArticleRepository $articleRepository): JsonResponse
    {
        $codes = $articleRepository->findAllArticleCodes();
